...
var articleDescription = "Desc for art 1";
var articlePrice = 10;
...
var buyerBalanceBeforeBuy, buyerBalanceAfterBuy;
 ...
 it("shoud be initialized with empty values", function(){
   return ChainList.deployed().then(function(instance){
    ...
    assert.equal(data[3],"","article must be empty");
 ...
 it("should sell an article", function(){
  ...
  it("should buy an article", function(){
    return ChainList.deployed().then(function(instance){
      ...
      assert(sellerBalanceAfterBuy = sellerBalanceBeforeBuy + articlePrice,"seller shoud have earned " + articlePrice + " eth");
      assert(buyerBalanceAfterBuy <= buyerBalanceBeforeBuy - articlePrice,"buyer shoud have paid " + articlePrice + " eth");
